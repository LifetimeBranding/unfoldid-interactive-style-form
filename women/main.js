...
unfoldid = {
  ...
  properties: {
    ...
    carousels: [
      ...
      {
        selector: '#carousel-favorite-shoes-photo',
        options: {
          slidesToShow: 1,
          slidesToScroll: 1,
          dots: true,
      ...
      {
        selector: '#carousel-favorite-topper-photo',
        options: {
          slidesToShow: 1,
          slidesToScroll: 1,
          dots: true,
      ...
      {
        selector: '#carousel-favorite-earrings-photo',
        options: {
          slidesToShow: 2,
          slidesToScroll: 2,
          dots: true,
      ...
      {
        selector: '#carousel-outfit-sets-photo',
        options: {
          slidesToShow: 1,
          slidesToScroll: 1,
          dots: true,
              ...
              switch (currentButton) {
                case "#button-your-style-start":
                  u.refreshCarousels([
                    ...
                    '#carousel-favorite-shoes-photo',
                    '#carousel-favorite-topper-photo',
                    '#carousel-favorite-earrings-photo',
                    '#carousel-outfit-sets-photo',
                  ])
                  break
...
function getFormData() {
  var elements = document.getElementById("womens-form").elements; // all form elements
